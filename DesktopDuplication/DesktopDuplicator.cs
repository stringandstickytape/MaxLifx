...
namespace DesktopDuplication
{
    ...
    public class DesktopDuplicator
    {
        ...
        private void RetrieveCursorMetadata(DesktopFrame frame)
        {
            ...
            if (updatePosition)
            {
                pointerInfo.Position = new System.Drawing.Point(frameInfo.PointerPosition.Position.X, frameInfo.PointerPosition.Position.Y);
    ...
    {
        public static int Width(this SharpDX.Mathematics.Interop.RawRectangle i)
        {
            return i.Right - i.Left;
        }

        public static int Height(this SharpDX.Mathematics.Interop.RawRectangle i)
        {
            return i.Bottom - i.Top;
        }

        public static int X(this SharpDX.Mathematics.Interop.RawRectangle i)
        {
            return i.Left;
        }

        public static int Y(this SharpDX.Mathematics.Interop.RawRectangle i)
        {
            return i.Top;
        }
    }
